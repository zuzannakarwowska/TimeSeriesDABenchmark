...
new_df <- mesnage_res_mean %>% select(-c('sample_size', 'rep')) / n_mesnage
...
ggsave(
  filename = "/Users/zkarwowska/Desktop/mesnage_lineplot.pdf",
  plot = g,
  width = 10,
  height = 5,
  units = "in",
...
full_dataset <- mesnage_res_mean %>% filter(sample_size == 60) %>% round()
...
ggsave(
  filename = "/Users/zkarwowska/Desktop/mesnage_venn.pdf",
  plot = g,
  width = 7,
  height = 7,
  units = "in",
