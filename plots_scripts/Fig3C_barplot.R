...
results_dir <- '/Users/zkarwowska/new_embl_folder/zeevi_dataset_v5/results/trendyspliner/one_arm/log/'
...
for (sample_size in c(10, 30, 50, 60)){
  ...
  # Combine all results
  dfs <- list(linda_tp, maaslin_clr_tp, maaslin_log_tp, zinb_tp, wilcoxon_clr_tp, wilcoxon_log_tp, spliner_clr_tp, spliner_log_tp, 
              metasplines_tp, nbmm_tp,nbzimm_tp )
